...
use PapaLocal\Referral\Workflow\GuardCreateSubscriber;
...
/**
 * Class GuardCreateSubscriberTest
 * @package Test\Unit\Referral\Workflow
 */
class GuardCreateSubscriberTest extends TestCase
{
    public function testConfirmCanCreateReferralSetsTransitionBlockerWhenAgreementIsInactive()
    {
    ...
    $agreementMock->expects($this->once())
        ...
        $guardMock = new GuardCreateSubscriber($appBusMock, $raMessageFactoryMock, $iaMessageFactoryMock);
        $guardMock->confirmCanCreateReferral($guardEventMock);
    }

    public function testConfirmCanCreateReferralDoesNotSetTransitionBlockerWhenAgreementIsActive()
    {
        $agreementGuidMock = $this->createMock(Guid::class);
    ...
    public function testConfirmCanCreateReferralSetsTransitionBlockerWhenContactIsUser()
    {
    ...
    public function testConfirmCanCreateReferralDoesNotSetTransitionBlockerWhenContactIsNotUser()
    {
        $emailAddress = 'test@papalocal.com';
